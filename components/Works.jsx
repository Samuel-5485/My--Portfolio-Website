...
const Works = ({ isDarkMode }) => {
    return (
        <div id="work" className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <h4 className='text-center mb-2 text-lg font-Ovo text-gray-600 dark:text-gray-400'>My Portfolio</h4>
    ...
    group"
                        ...
                        <div className="bg-white dark:bg-darkHover w-10/12 rounded-md absolute bottom-5
                        ...
                        justify-between duration-500 group-hover:bottom-7">
                            ...
                            aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] dark:shadow-[2px_2px_0_#fff] group-hover:bg-lime-300 transition">
            ...
            <a href="" className="w-max flex items-center justify-center gap-2
                                text-gray-700 dark:text-white border-[0.5px] border-gray-700 dark:border-white/50 rounded-full py-3 px-10 mx-auto
                                my-20 hover:bg-lightHover dark:hover:bg-darkHover duration-500">
